...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=IAMJL; Initial Catalog=registroAlumno;User ID=Leonidas;Password = root123; Encrypt=False");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Alumno>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__alumno__3213E83F904DF351");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__asignatu__3213E83FC4EFBC9A");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__califica__3213E83F93280FCC");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__matricul__3213E83F4305005F");
        ...
        {
            entity.HasKey(e => e.Usuario).HasName("PK__profesor__9AFF8FC7961C672E");
